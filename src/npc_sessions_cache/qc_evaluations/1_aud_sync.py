...
from npc_sessions_cache.plots.audio import plot_microphone_response, plot_audio_waveforms
plot_audio_target_waveforms = functools.partial(plot_audio_waveforms, target_stim=True)
plot_audio_nontarget_waveforms = functools.partial(plot_audio_waveforms, target_stim=False)
